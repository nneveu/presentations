...
shorten the simulation time. GAs require several thousand
simulations to converge. Reduction in the fidelity 
...
To create a comparable Pareto front, the GA required 51,200
simulations (400 generations of 128 simulations) and approximately 1,700 core-hours of computation, shown as the black line
below. We also show the approximate Pareto front after the GAs 19th generation (blue line below), since this is roughly the same
number of simulation evaluations as used by the model-based method.

  
The optimization variables (Table~\ref{params}) 
