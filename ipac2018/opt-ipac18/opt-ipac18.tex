...
A random sample was done to decide initial conditions, 
then ten local optimizations were started. The results 
from all ten runs were used to form a Pareto front
...
credibility to the perception that the model based work is giving 
valid results.
