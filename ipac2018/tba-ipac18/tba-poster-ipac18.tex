\documentclass[portrait,final,paperwidth=105cm, paperheight=160cm,  fontscale=0.277]{baposter}
%a0paper,
\usepackage{calc}
\usepackage{graphicx}
\usepackage{amsmath}
...
{\bf\textsc{Staged Two Beam Acceleration \\
		\vspace{0.3em} Beam Line Design for the AWA Facility}}%\vspace{10em}}
% Authors
{\vspace{1em}
...
\begin{centering}
	...
	\begin{tikzpicture}[scale=0.825, text=black]
	\input{tikz-tba.tex}
	\end{tikzpicture}
\end{centering}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		work done at Indiana University \cite{kicker,korea}. The plates will be 
...
\begin{tikzpicture}[every node/.style={anchor=south west,inner sep=0pt},x=1mm, y=1mm,]   
\node (fig1) at (0,0)
{\includegraphics[width=0.7\textwidth]{kicker-hv}};
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{References}{name=ref,column=0,above=bottom, span=3}{%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\noindent 
\tiny
\begingroup
...
\vspace{1em}
\begin{centering}
	\includegraphics[width=0.15\textwidth]{logos/aps-logo}\hspace{5mm}
	\includegraphics[width=0.4\textwidth]{logos/DOE_logo_color_cmyk}
